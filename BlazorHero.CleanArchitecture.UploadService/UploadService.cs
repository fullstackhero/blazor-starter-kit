...
using BlazorHero.CleanArchitecture.Utils.Extensions;

namespace BlazorHero.CleanArchitecture.UploadService
{
    public class UploadService : IUploadService
    {
        public string UploadAsync(IUploadRequest request)
        {
