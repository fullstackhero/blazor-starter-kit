        ...
        public async Task<byte[]> ExportToExcelAsync()
        {
            ...
            foreach (var item in trails)
            {
                ...
                ws.Cells[rowIndex, colIndex++].Value =
                    DateTime.SpecifyKind(item.DateTime, DateTimeKind.Utc).ToLocalTime().ToString("dd/MM/yyyy HH:mm:ss");
                ws.Cells[rowIndex, colIndex++].Value = item.DateTime.ToString("dd/MM/yyyy HH:mm:ss");
